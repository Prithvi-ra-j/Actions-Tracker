...
export async function generateDummyData() {
  ...
  const data = {
    ...
    settings: [
      ...
      { key: 'lastStatTitles', value: JSON.stringify({ body: "Apprentice", discipline: "Apprentice", knowledge: "Apprentice", social: "Apprentice", creativity: "Apprentice", strategy: "Apprentice" }) }
    ],
    axis_config: [
      { axis: 'body', enabled: true, weight: 1, hasConsistencyTerm: true },
      ...
      // Edge Case: Social has no consistency term
      { axis: 'social', enabled: true, weight: 1, hasConsistencyTerm: false },
    ...
    logs: [
      // Onboarding logs
      { id: generateId(), localDate: dateOffset(-60), text: 'Initial Baseline: 5', axis: 'body', value: 5, override: true, createdAt: timeOffset(-60) },
      ...
      // High volume body day
      { id: generateId(), localDate: dateOffset(-10), text: 'Deadlift PR', axis: 'body', value: 15, override: false, createdAt: timeOffset(-10) },
      { id: generateId(), localDate: dateOffset(-10), text: 'Squat Volume', axis: 'body', value: 10, override: false, createdAt: timeOffset(-10) }
    ],
    questBoard: [
      // Active quest
      { id: 'q1', title: 'Read 10 Books', axis: 'knowledge', targetValue: 10, currentValue: 4, unit: 'books', done: false, createdAt: timeOffset(-20) },
      // Completed quest
      { id: 'q2', title: 'Run a Marathon', axis: 'body', targetValue: 1, currentValue: 1, unit: 'marathons', done: true, createdAt: timeOffset(-40), completedAt: timeOffset(-1) },
      // Edge case: targetValue 0
      { id: 'q3', title: 'Meditate (Endless)', axis: 'social', targetValue: 0, currentValue: 5, unit: 'sessions', done: false, createdAt: timeOffset(-5) },
      // AI Insight Quest
    ...
    insights: [
      ...
      // Confirmed insight
      { id: 'ins1', type: 'recommendation', title: 'Diet Strategy', description: 'Your body volume is high but your energy is low.', recommendedActions: ['Re-evaluate diet plan'], status: 'confirmed', createdAt: timeOffset(-2) },
      // Rejected insight
    ...
    audits: [
      { id: 'aud1', periodStart: '2026-08', periodEnd: '2026-08', title: 'August 2026 Monthly Audit', summary: 'A strong month for body, but knowledge lagged.', axes: { body: { delta: '+5', narrative: 'Great progress.' } }, status: 'finalized', createdAt: timeOffset(-13) }
    ],
    decisions: [
    ...
    statSnapshots: [
      { id: 'ss1', date: dateOffset(-60), stats: { body: 5, discipline: 3, knowledge: 0, social: 0, creativity: 0, strategy: 0 } },
      { id: 'ss2', date: dateOffset(-30), stats: { body: 20, discipline: 15, knowledge: 5, social: 0, creativity: 0, strategy: 0 } },
      { id: 'ss3', date: dateOffset(-10), stats: { body: 40, discipline: 20, knowledge: 10, social: 2, creativity: 0, strategy: 0 } },
      { id: 'ss4', date: dateOffset(0), stats: { body: 45, discipline: 25, knowledge: 15, social: 5, creativity: 2, strategy: 0 } }
    ],
    goals: [],
    milestones: [],
    gymSessions: [],
