  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        display: currentTab === 'jarvis' ? 'flex' : 'block',
        flexDirection: currentTab === 'jarvis' ? 'column' : undefined,
        height: currentTab === 'jarvis'
          ? 'calc(100dvh - 64px - env(safe-area-inset-bottom, 0px))'
          : undefined,
